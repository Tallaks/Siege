	...
	public static class ZenUtilInternal
	{
			...
			GameObject gameObject, List<MonoBehaviour> injectableComponents)
		{
			...
			for (var i = 0; i < gameObject.transform.childCount; i++)
			{
				...
				if (child != null) GetInjectableMonoBehavioursUnderGameObjectInternal(child.gameObject, injectableComponents);
			}
		...
		public static IEnumerable<GameObject> GetRootGameObjects(Scene scene)
		{
...
#endif
			{
				...
				return Resources.FindObjectsOfTypeAll<GameObject>().Where(x => x.transform.parent == null
