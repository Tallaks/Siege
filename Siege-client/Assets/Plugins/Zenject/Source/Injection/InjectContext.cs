	...
	public class InjectContext : IDisposable
	{
		...
		public IEnumerable<InjectContext> ParentContexts
		{
			get
			{
				...
				foreach (InjectContext context in ParentContext.ParentContexts) yield return context;
			}
		}
		...
		public IEnumerable<InjectContext> ParentContextsAndSelf
		{
			get
			{
				...
				foreach (InjectContext context in ParentContexts) yield return context;
			}
		}
