...
namespace Zenject.Internal
{
	...
	public static class SceneParentAutomaticLoader
	{
		...
		public static void ValidateMultiSceneSetupAndLoadDefaultSceneParents()
		{
			...
			foreach (LoadedSceneInfo sceneInfo in sceneInfos) ProcessScene(sceneInfo, contractMap, defaultContractsMap);
		}
			...
			List<LoadedSceneInfo> sceneInfos)
		{
			...
			foreach (LoadedSceneInfo info in sceneInfos) AddToContractMap(contractMap, info);
