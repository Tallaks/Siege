...
{
  public class SessionService<T> where T : struct, ISessionPlayerData
  {
    ...
    public static SessionService<T> Instance => s_Instance ??= new SessionService<T>();

    static SessionService<T> s_Instance;
